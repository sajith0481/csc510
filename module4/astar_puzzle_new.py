...
def get_initial_state():
    ...
    print("You must enter each number from 0 to 8 exactly once.")
    ...
    while True:
        ...
        if sorted(entries) == list(range(9)):
            break
        else:
            print("\nInvalid puzzle. You must use every number from 0 to 8 exactly once.")
            print("Please enter the puzzle again.\n")
